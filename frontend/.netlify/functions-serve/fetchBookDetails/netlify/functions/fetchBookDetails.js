...
// netlify/functions/fetchBookDetails.js
var fetchBookDetails_exports = {};
__export(fetchBookDetails_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(fetchBookDetails_exports);
...
async function handler(event) {
  ...
  const bookId = event.queryStringParameters.book_id;
  ...
  try {
    ...
    const bookDetails = {
      ...
      // Ensure quantity has a fallback value
    };
    return {
      statusCode: 200,
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=fetchBookDetails.js.map
