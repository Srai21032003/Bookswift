...
var addToCart_exports = {};
__export(addToCart_exports, {
  handler: () => handler
});
module.exports = __toCommonJS(addToCart_exports);
...
// netlify/functions/addToCart.js
var JWT_SECRET2 = process.env.JWT_SECRET || "your-very-secret-key";
